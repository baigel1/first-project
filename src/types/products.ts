...
export enum C_productHierarchy {
  BRANDS = "Brands",
  BRANDS___FRUITBOYS = "Brands > Fruitboys",
  BRANDS___VEGETABLELAND = "Brands > VegetableLand",
  BANDS___DAIRYKINGS = "Bands > DairyKings",
  BRANDS___FRUITBOYS___PULPIES = "Brands > Fruitboys > Pulpies",
}

export interface C_zendeskComments {
  title?: string;
  body?: string;
}
...
export interface Product {
  ...
  name: string;
  c_linkedLocation?: EntityReference[];
  c_photo?: Image;
  c_productHierarchy?: C_productHierarchy[];
  c_testing?: EntityReference[];
  c_text_list_test?: string[];
  c_zendeskComments?: C_zendeskComments[];
